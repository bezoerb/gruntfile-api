...
(function(root, factory) {
     ...
     *
     * Available options
     * @option {bool} append    [OPTIONAL] Default: true
     * @option {bool} prepend   [OPTIONAL] Default: false
     * @option {bool} overwrite [OPTIONAL] Default: false - will invalidate other options when set to true
     *
     * @returns {*}
     */
    function registerTask(identifier, task, options) {
        var params = _.assign({append: true, prepend: false, overwrite: false}, options),
        ...
        traversal.forEach(function(node) {
            ...
            // task with the same name ist registered.
            // Task definition is an array and task is function. Prepend, append, or overwrite based on options.
                ...
                // add array elements to function body based on options
                code = 'var tmp = ' + taskDefinition;
            ...
            // registered task is function and task is array
